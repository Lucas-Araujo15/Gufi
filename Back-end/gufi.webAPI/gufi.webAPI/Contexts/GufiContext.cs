    ...
    public partial class GUFIContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //optionsBuilder.UseSqlServer("Server=tcp:senai-gufi.database.windows.net,1433;Initial Catalog=GUFI;Persist Security Info=False;User ID=?;Password=?;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
                optionsBuilder.UseSqlServer("Data Source=NOTE0111B1\\SQLEXPRESS; Initial Catalog=GUFI; user id=sa; pwd=Senai@132;");
            }
        }
